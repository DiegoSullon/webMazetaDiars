...
//yarn import logo from './logo.svg';
...
console.log(this.state.form);
  ...
  render(){
   ...
   //<button onClick={()=>this.cerrarSesion()}>Cerrar Sesión</button><br />
    const {form}=this.state;
  return (
    <div className="App">
    <br /><br /><br />
  <button className="btn btn-success" onClick={()=>{this.setState({form: null, tipoModal: 'insertar'}); this.modalInsertar()}}>Agregar Orden de Compra</button>
  <br /><br />
